...
def mybatch_generator_prediction(tstfiles, img_rows, img_cols, batch_size, max_possible_input_value=65536):
    ...
    while True:
        ...
        #stack R G B NIR together for every image in the batch and resize to in_rows X in_cols
...
def pre_load_images(tstfiles, img_rows, img_cols, batch_size, max_possible_input_value=65536):
    #print("Generating single batch for performance measurement")
    #tstfiles already is the complete batch
    image_list = []
